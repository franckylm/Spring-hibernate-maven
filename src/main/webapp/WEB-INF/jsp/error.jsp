...
<html lang="en">
  ...
  <body>
    <div class="container">
      ...
      <div class="jumbotron">
        <h1>Oooops Error !!!</h1>
        <p class="lead">Invalid username and/or password, please try.</p>
        <p><a class="btn btn-lg btn-success" href="<c:url value="/application/home/connected" />">Sign in again</a></p>
      </div>
